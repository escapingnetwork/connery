module Route.Support exposing (Model, Msg, RouteParams, route, Data, ActionData)
...
view app shared =
    ...
    , body =
        [ Html.div [ Attrs.class "mx-auto prose max-w-none pb-8 pt-8 dark:prose-invert xl:col-span-2 xl:max-w-5xl xl:px-0" ]
            ...
            , Html.iframe
                [ Attrs.attribute "data-tally-src" "https://tally.so/embed/wadQYE?alignLeft=1&hideTitle=1&transparentBackground=1&dynamicHeight=1"
                , Attrs.attribute "frameborder" "0"
                , Attrs.style "width" "100%"
                , Attrs.height 600
                , Attrs.class "mx-auto prose dark:prose-invert xl:max-w-5xl xl:px-0"
                , Attrs.title "Contact us"
                , Attrs.src "https://tally.so/embed/wadQYE?alignLeft=1&hideTitle=1&transparentBackground=1&dynamicHeight=1"
                ]
                []
            ]
        ]
