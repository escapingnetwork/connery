module Gen.Our_Schools.SelfCatering exposing (annotation_, make_, moduleName_, route, values_)
...
route =
    Elm.value
        { importFrom = [ "Route", "Services", "SelfCatering" ]
        , name = "route"
        , annotation =
            Just
                (Type.namedWith
...
annotation_ =
    ...
    , msg = Type.namedWith [ "Route", "Services", "SelfCatering" ] "Msg" []
    }
