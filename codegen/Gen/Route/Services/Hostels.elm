module Gen.Our_Schools.Hostels exposing (annotation_, make_, moduleName_, route, values_)
...
route =
    Elm.value
        { importFrom = [ "Route", "Services", "Hostels" ]
        , name = "route"
        , annotation =
            Just
                (Type.namedWith
...
annotation_ =
    ...
    , msg = Type.namedWith [ "Route", "Services", "Hostels" ] "Msg" []
    }
