module Gen.Html.Events exposing (call_, custom, keyCode, moduleName_, on, onBlur, onCheck, onClick, onDoubleClick, onFocus, onInput, onMouseDown, onMouseEnter, onMouseLeave, onMouseOut, onMouseOver, onMouseUp, onSubmit, preventDefaultOn, stopPropagationOn, targetChecked, targetValue, values_)
...
stopPropagationOn: String -> Json.Decode.Decoder ( msg, Bool ) -> Html.Attribute msg
-}
...
preventDefaultOn: String -> Json.Decode.Decoder ( msg, Bool ) -> Html.Attribute msg
-}
