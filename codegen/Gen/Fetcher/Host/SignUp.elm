module Gen.Fetcher.Host.SignUp exposing (call_, moduleName_, submit, values_)
...
{-| submit: 
    (Result Http.Error Route.Host.SignUp.ActionData -> msg)
...
submit submitArg submitArg0 =
    Elm.apply
        (Elm.value
            { importFrom = [ "Fetcher", "Host", "SignUp" ]
            , name = "submit"
            , annotation =
                Just
                    (Type.function
