module Gen.Fetcher.PrivacyPolicy exposing (call_, moduleName_, submit, values_)
...
moduleName_ =
    [ "Fetcher", "PrivacyPolicy" ]


{-| submit: 
    (Result Http.Error Route.PrivacyPolicy.ActionData -> msg)
...
submit submitArg submitArg0 =
    Elm.apply
        (Elm.value
            { importFrom = [ "Fetcher", "PrivacyPolicy" ]
            , name = "submit"
            , annotation =
                Just
                    (Type.function
