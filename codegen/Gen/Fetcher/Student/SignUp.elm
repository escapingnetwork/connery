module Gen.Fetcher.Student.SignUp exposing (call_, moduleName_, submit, values_)
...
moduleName_ =
    [ "Fetcher", "Student", "SignUp" ]


{-| submit: 
    (Result Http.Error Route.Student.SignUp.ActionData -> msg)
...
submit submitArg submitArg0 =
    Elm.apply
        (Elm.value
            { importFrom = [ "Fetcher", "Student", "SignUp" ]
            , name = "submit"
            , annotation =
                Just
                    (Type.function
