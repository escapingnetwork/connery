module Gen.Fetcher.Booking.TermsAndConditions exposing (call_, moduleName_, submit, values_)
...
moduleName_ =
    [ "Fetcher", "Booking", "TermsAndConditions" ]


{-| submit: 
    (Result Http.Error Route.Booking.TermsAndConditions.ActionData -> msg)
...
submit submitArg submitArg0 =
    Elm.apply
        (Elm.value
            { importFrom = [ "Fetcher", "Booking", "TermsAndConditions" ]
            , name = "submit"
            , annotation =
                Just
                    (Type.function
