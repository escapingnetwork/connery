module Gen.Fetcher.Services.Hostels exposing (call_, moduleName_, submit, values_)
...
moduleName_ =
    [ "Fetcher", "Services", "Hostels" ]


{-| submit: 
    (Result Http.Error Our_Schools.Hostels.ActionData -> msg)
...
submit submitArg submitArg0 =
    Elm.apply
        (Elm.value
            { importFrom = [ "Fetcher", "Services", "Hostels" ]
            , name = "submit"
            , annotation =
                Just
                    (Type.function
