module Gen.Fetcher.Services.Slug_ exposing (call_, moduleName_, submit, values_)
...
moduleName_ =
    [ "Fetcher", "Services", "Slug_" ]


{-| submit: 
    (Result Http.Error Our_Schools.Slug_.ActionData -> msg)
...
submit submitArg submitArg0 =
    Elm.apply
        (Elm.value
            { importFrom = [ "Fetcher", "Services", "Slug_" ]
            , name = "submit"
            , annotation =
                Just
                    (Type.function
