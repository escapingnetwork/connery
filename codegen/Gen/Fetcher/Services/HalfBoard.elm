module Gen.Fetcher.Services.HalfBoard exposing (call_, moduleName_, submit, values_)
...
submit submitArg submitArg0 =
    Elm.apply
        (Elm.value
            { importFrom = [ "Fetcher", "Services", "HalfBoard" ]
            , name = "submit"
            , annotation =
                Just
                    (Type.function
