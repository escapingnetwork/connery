module Gen.Fetcher.Services.SelfCatering exposing (call_, moduleName_, submit, values_)
...
moduleName_ =
    [ "Fetcher", "Services", "SelfCatering" ]


{-| submit: 
    (Result Http.Error Our_Schools.SelfCatering.ActionData -> msg)
...
submit submitArg submitArg0 =
    Elm.apply
        (Elm.value
            { importFrom = [ "Fetcher", "Services", "SelfCatering" ]
            , name = "submit"
            , annotation =
                Just
                    (Type.function
