module Gen.Fetcher.Partner.SignUp exposing (call_, moduleName_, submit, values_)
...
moduleName_ =
    [ "Fetcher", "Partner", "SignUp" ]


{-| submit: 
    (Result Http.Error Route.Partner.SignUp.ActionData -> msg)
...
submit submitArg submitArg0 =
    Elm.apply
        (Elm.value
            { importFrom = [ "Fetcher", "Partner", "SignUp" ]
            , name = "submit"
            , annotation =
                Just
                    (Type.function
