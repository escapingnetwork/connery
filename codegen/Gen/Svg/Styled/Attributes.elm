...
{-| 
@docs values_, call_, writingMode, wordSpacing, visibility, unicodeBidi, textRendering, textDecoration, textAnchor, stroke, strokeWidth, strokeOpacity, strokeMiterlimit, strokeLinejoin, strokeLinecap, strokeDashoffset, strokeDasharray, stopOpacity, stopColor, shapeRendering, pointerEvents, overflow, opacity, mask, markerStart, markerMid, markerEnd, lightingColor, letterSpacing, kerning, imageRendering, glyphOrientationVertical, glyphOrientationHorizontal, fontWeight, fontVariant, fontStyle, fontStretch, fontSize, fontSizeAdjust, fontFamily, floodOpacity, floodColor, filter, fill, fillRule, fillOpacity, enableBackground, dominantBaseline, display, direction, cursor, color, colorRendering, colorProfile, colorInterpolation, colorInterpolationFilters, clip, clipRule, clipPath, baselineShift, alignmentBaseline, zoomAndPan, z, yChannelSelector, y2, y1, y, xmlSpace, xmlLang, xmlBase, xlinkType, xlinkTitle, xlinkShow, xlinkRole, xlinkHref, xlinkArcrole, xlinkActuate, xChannelSelector, x2, x1, xHeight, x, widths, width, viewTarget, viewBox, vertOriginY, vertOriginX, vertAdvY, version, values, vMathematical, vIdeographic, vHanging, vAlphabetic, unitsPerEm, unicodeRange, unicode, underlineThickness, underlinePosition, u2, u1, type_, transform, to, title, textLength, targetY, targetX, target, tableValues, systemLanguage, surfaceScale, style, string, strikethroughThickness, strikethroughPosition, stitchTiles, stemv, stemh, stdDeviation, startOffset, spreadMethod, speed, specularExponent, specularConstant, spacing, slope, seed, scale, ry, rx, rotate, result, restart, requiredFeatures, requiredExtensions, repeatDur, repeatCount, renderingIntent, refY, refX, radius, r, primitiveUnits, preserveAspectRatio, preserveAlpha, pointsAtZ, pointsAtY, pointsAtX, points, pointOrder, patternUnits, patternTransform, patternContentUnits, pathLength, path, panose1, overlineThickness, overlinePosition, origin, orientation, orient, order, operator, offset, numOctaves, name, mode, min, method, media, max, mathematical, maskUnits, maskContentUnits, markerWidth, markerUnits, markerHeight, local, limitingConeAngle, lengthAdjust, lang, keyTimes, keySplines, keyPoints, kernelUnitLength, kernelMatrix, k4, k3, k2, k1, k, intercept, in2, in_, ideographic, id, horizOriginY, horizOriginX, horizAdvX, height, hanging, gradientUnits, gradientTransform, glyphRef, glyphName, g2, g1, fy, fx, from, format, filterUnits, filterRes, externalResourcesRequired, exponent, end, elevation, edgeMode, dy, dx, dur, divisor, diffuseConstant, descent, decelerate, d, cy, cx, contentStyleType, contentScriptType, clipPathUnits, class, capHeight, calcMode, by, bias, begin, bbox, baseProfile, baseFrequency, azimuth, autoReverse, attributeType, attributeName, ascent, arabicForm, amplitude, allowReorder, alphabetic, additive, accumulate, accelerate, accentHeight, fromUnstyled, css, moduleName_
-}
