module Gen.Svg.Styled.Lazy exposing (call_, lazy, lazy2, lazy3, lazy4, lazy5, lazy6, lazy7, moduleName_, values_)
...
lazy2: (a -> b -> Svg.Styled.Svg msg) -> a -> b -> Svg.Styled.Svg msg
-}
lazy2 :
...
lazy3: (a -> b -> c -> Svg.Styled.Svg msg) -> a -> b -> c -> Svg.Styled.Svg msg
-}
lazy3 :
...
lazy7: 
    (a -> b -> c -> d -> e -> f -> g -> Svg.Styled.Svg msg)
    -> a
    -> b
    -> c
    -> d
